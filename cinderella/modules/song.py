...
from cinderella.inlinehelper import arq
from cinderella.pluginhelpers import get_text, progress
from services.pyrogram import pbot as Client
...
async def ytmusic(client, message: Message):
    ...
    if dl_limit >= 4:
        await message.reply_text(
            "IronMusic server busy due to too many downloads, try again after sometime."
        )
        return
