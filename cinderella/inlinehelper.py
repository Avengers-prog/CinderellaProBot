...
from cinderella import BOT_USERNAME, OWNER_ID
from cinderella.config import get_str_key
from cinderella.pluginhelpers import convert_seconds_to_minutes as time_convert
from cinderella.pluginhelpers import fetch
...
async def alive_function(answers):
    ...
    msg = f"""
**[DaisyX✨](https://github.com/Avengers-prog/CinderellaProBot)**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Platform:** `{sys.platform}`
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/Ironbotmusic)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/54db70f254df017324cef.jpg",
